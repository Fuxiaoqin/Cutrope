...
if (window.location.href.indexOf('121.41.83.91') !== -1) {
    ...
    moreMyUserAgent(function(Version){
      ...
      if( (compareAppVersion ('2.8.1',Version) || Version == '2.8.0' ) && Version){
...
// function buriedPoint(oneWeb, twoWeb, threeWeb, columned, behavior, clickResults, statisticalType,accessOccurred, type_id, previousWebType){
//     var json = {
//         'one_web': oneWeb,
//         'two_web': twoWeb,
//         'three_web': threeWeb,
...
//         'access_occurred_type':accessOccurred,
//         'access_occurred_type_id': type_id,
